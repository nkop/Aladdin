...
<!--<![endif]-->
<head>
<title>Talenten | Aladdin</title> {include
...
<body class="header-fixed">
	...
	<div class="wrapper">
		...
		<div class="minimalheight">
			{if ($text =='Logout')} {if $wishesCount eq 3}
			<div class="container content">
				<div class="panel-group">
					...
					{/if} {/if}
					<div class="faqHeader">
						<i class="fa fa-star"></i> Vul uw talent in
					</div>
					<div class="">
						<form class="reg-page"
							action="Controller/Handlers/talentHandler.php" method="post">
										...
										<fieldset>
											...
											<div class="col col-lg-2">
												<label class="checkbox-inline"><input
													type="checkbox" name="tags[]" value={$tag->tagId}
					...
					{if !empty($talentArray)}
					<div class="faqHeader">
						<i class="fa fa-star"></i> Dit zijn uw Talenten
					</div>
					<div>
						<table class="table table-striped">
							...
							<tr>
								...
								<td>{foreach from=$talent->talentTags item=tag}
									{$tag->tagName}, {/foreach}</td>
								<td class=" class=" colcol-md-2" wishestableright">{$talent->talentStatus}</td>
							</tr>
							{/foreach}
						</table>
					</div>
				...
				<div class="container content">
					<div class="panel-group">
						<div class="faqHeader">
							<i class="fa fa-exclamation"></i> Vul eerst 3 wensen in
						</div>
					</div>
					{/if} {else}
					<div class="container content">
