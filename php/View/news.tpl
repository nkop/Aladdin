        ...
        <div class="row margin-bottom-20">
            ...
            <div class="col-sm-7">
                <div class="news-v3">
                    ...
                    <h2><a href="NewsItemController.php">Nieuwe website!</a></h2>
        ...
        <div class="row margin-bottom-20">
            ...
            <div class="col-sm-7">
                <div class="news-v3">
                    ...
                    <h2><a href="newsItemController.php">Gelukkig nieuwjaar!</a></h2>
                    <p>Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus tellus, imperdiet molestie est volutpat at. Sed viverra cursus nibh, sed consectetur ipsum sollicitudin sed. Cras erat est, euismod id congue sed, sollicitudin sed odio. Nullam non metus in mi rhoncus efficitur...</p>
                    <ul class="post-shares">
                        <li><a href="#"><i class="rounded-x fa fa-facebook float"></i></a></li>
                    </ul>
        ...
        <div class="row margin-bottom-20">
            ...
            <div class="col-sm-7">
                <div class="news-v3">
                    ...
                    <h2><a href="NewsItemController.php">Video van Aladdin</a></h2>
                    <p>Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus tellus, imperdiet molestie est volutpat at. Sed viverra cursus nibh, sed consectetur ipsum sollicitudin sed. Cras erat est, euismod id congue sed, sollicitudin sed odio. Nullam non metus in mi rhoncus efficitur...</p>
                    <ul class="post-shares">
                        <li><a href="#"><i class="rounded-x fa fa-facebook float"></i></a></li>
                    </ul>
        ...
        <div class="row margin-bottom-20">
            ...
            <div class="col-sm-7">
                <div class="news-v3">
                    ...
                    <h2><a href="NewsItemController.php">Lorem ipsum</a></h2>
                    <p>Nullam elementum tincidunt massa, a pulvinar leo ultricies ut. Ut fringilla lectus tellus, imperdiet molestie est volutpat at. Sed viverra cursus nibh, sed consectetur ipsum sollicitudin sed. Cras erat est, euismod id congue sed, sollicitudin sed odio. Nullam non metus in mi rhoncus efficitur...</p>
                    <ul class="post-shares">
                        <li><a href="#"><i class="rounded-x fa fa-facebook float"></i></a></li>
                    </ul>
