...
<!--<![endif]-->
<head>
<title>Nieuws | Aladdin</title> {include
		...
		<div class="container content-md">
			...
			<div class="row margin-bottom-20">
				<div class="col-sm-5 sm-margin-bottom-20">
					{if $newsItem->isvideo}
					<div class="responsive-video">{$newsItem->thumbnail}</div>
					{else} <img class="img-responsive"
						src="{$newsItem->thumbnail|replace:'../../../':''}" alt="">
					{/if}
				...
				<div class="col-sm-7">
					<div class="news-v3">
						...
						<h2>
							<a
								href="index.php?controller=newsItem&action=News&id={$newsItem->nieuwsitemid}">{$newsItem->titel}</a>
						</h2>
						{$newsItem->tekst|strip_tags|truncate:300:"...":true}

						<ul class="post-shares">
							<li><a href="#"><i
									class="rounded-x fa fa-facebook float"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
