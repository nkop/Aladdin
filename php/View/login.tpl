...
<!--<![endif]-->
<head>
<title>Login | Aladdin</title> {include
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
					...
					<div class='alert alert-danger'>
						<strong>Error!</strong> gebruikersnaam en wachtwoord komen niet
						overeen!
					</div>
					{/if} {if $banned}
					<div class='alert alert-danger'>
					...
					<form class="reg-page"
						action="Controller/Handlers/userloginHandler.php" method="post">
						...
						<p>
							<a class="color-green"
								href="index.php?controller=recovery&action=Index">Klik hier</a>
							om uw wachtwoord te resetten.
						</p>
						<h4>Nog geen account ?</h4>
						<p>
							<a class="color-green"
								href="index.php?controller=register&action=Index">Klik hier</a>
