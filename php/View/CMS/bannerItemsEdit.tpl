...
<!-- 		           LINK HIERONDER AANPASSEN!!! -->
		                ...
		                <a href="admin.php?controller=editBanner&action=banner" class="btn btn_succes">Nieuwe banner</a>
...
<!-- 							HIERONDER OOK AANPASSEN! CONTROLLER SHIZZLEEE -->
							...
							<tr>
								...
								<td><img class="table-img" src="{$banner->afbeelding_groot|replace:'../../../':''}"/></td>
								<td class="center">	
								<a href="admin.php?controller=editBanner&action=Delete&id={$banner->banner_id}" class="btn btn-danger confirm"><i class="halflings-icon white remove"></i></a>
								<a href="admin.php?controller=editBanner&action=Banner&id={$banner->banner_id}" class="btn btn-warning"><i class="halflings-icon white edit"></i></a>	  
								</td>
							</tr>
							{/foreach}
							</tbody>
