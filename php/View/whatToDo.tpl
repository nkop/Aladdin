	...
	<div class="row">
		<div class="col-md-12">
		 	<div class="heading heading-v1 margin-bottom-40">
                        ...
                        <p>Welkom op Aladdin, in het ondestaande stappenplan kunt u precies zien hoe u de site kan gebruiken.</p>
